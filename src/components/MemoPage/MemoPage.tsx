          ...
          <main className='main-page-content'>
            <section className='page-section'>
              <article className='page-section-content'>
                ...
                <ul>
                  <li>
                    Закупки стартуют раз в две недели по вторникам в 09:00 и закрываются в среду в 19:00. 
                    График закупок всегда можно посмотреть в телеграм-канале 
                    «<a href='https://t.me/soc_coop_partners' target='_blank'>ПК СоцКооп Пайщики</a>»;
                  </li>
                  <li>
                  ...
                  <li>
                    Развоз заказов проходит по воскресеньям;
                  </li>
                </ul>
                <p>
