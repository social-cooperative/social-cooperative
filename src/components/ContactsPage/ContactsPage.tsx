        ...
        <div className='main-page'>
          <main className='main-page-content'>
            <Section style={{display: 'flex', flexDirection: 'column'}}>
              ...
              <p style={{marginBottom:16}}>
               Если вы живёте за пределами ближнего Подмосковья, то напишите или позвоните нам. В вашем случае кооператив оплатит 250 рублей из стоимости доставки до ближайшего к вам пункта выдачи заказов.
              </p>
