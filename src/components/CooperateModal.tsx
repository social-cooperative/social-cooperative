  ...
  return (
        ...
        >
            ...
            <DialogContent id="cooperate-dialog-description">
                <Root>
                    <Description>
                        Товары для кооперации — это товары, сгруппированные поставщиком в упаковки по несколько штук. Например, 12 килограммовых пачек риса в одной упаковке.
                    </Description>
                    <Description>
                        Для покупки таких товаров мы предлагаем пайщикам кооперироваться в таком формате:
                    </Description>
                       <List>
                        <li>Пайщики договариваются в чате о кооперации;</li>
                        <li>Пайщик №1 кладет себе в корзину товар помеченный для кооперации;</li>
                        <li>
                            В корзине пайщик №1 заполняет специальное поле, где указывает:
                            <ol>
                                <li>ФИО пайщика № 2 и телефон;</li>
                                <li>Прописывает какое количество товара получит пайщик № 1, а сколько пайщик №2.</li>
                            </ol>
                        </li>
                        <li>Пайщик № 1 оплачивает 100% товара;</li>
